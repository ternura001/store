...
sum1=(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140)
sum2=(86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60)
sum3=(135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.8*63+96.8*78)
sum=sum1+sum2+sum3
...
print("您的商城平均日销售数量为：",AVERAGE)

Txue=(63+45+129+63+58+48+63)/1844*100
chenshan=(120)/1844*100
fengyi=(43+25+43+60+43+78)/1844*100
niuzaiku=(60+72+35+90+60+60+140)/1844*100
picao=(63+24+63+57)/1844*100
yurongfu=(10+69+140+10+10)/1844*100
print("您每个种类月销售量占比为：","T血：","%.2f"%Txue,"%"
                           "衬衫：","%.2f"%chenshan,"%"
                           "风衣：","%.2f"%fengyi,"%"
                           "牛仔裤：","%.2f"%niuzaiku,"%"
                           "皮草：","%.2f"%picao,"%"
